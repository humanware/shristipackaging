...
<html>
<head>
	<title>Scheme | Shristi Packaging Company Pvt. Ltd.</title>
...
<body>
	<div id="container">
		<div class="header">
			...
			<nav class="menu">
				<ul class="umenu">
					...
					<li><a class="active" href="scheme.php">Scheme</a></li>
		...
		<div class="content">
			<h3>Scheme</h3>
			<img class="scheme" src="media/scheme1.jpg" />
			<br /><br />
			<img class="scheme" src="media/scheme2.jpg" />
